...
#include "dect_mac_sm.h"        // For dect_mac_event_msg, dect_mac_state_t, pending_op_type_t, dect_mac_event_type_t
#include <nrf_modem_dect_phy.h> // For enum nrf_modem_dect_phy_err
